...
namespace eHospital.Payment.Alipay
{
    ...
    public class Submit
    {
        ...
        private static string BuildRequestMysign(Dictionary<string, string> sPara)
        {
            ...
            var prestr = Core.CreateLinkString(sPara);
        ...
        private static string BuildRequestParaToString(SortedDictionary<string, string> sParaTemp, Encoding code)
        {
            ...
            var strRequestData = Core.CreateLinkStringUrlencode(sPara, code);
        ...
        {
            var url = GATEWAY_NEW + "service=query_timestamp&partner=" + Config.partner + "&_input_charset=" + Config.input_charset;
            var encrypt_key = string.Empty;
