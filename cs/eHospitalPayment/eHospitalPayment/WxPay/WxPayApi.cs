    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            WebApiConfig.log.Debug("WxPayApi", "MicroPay request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            WebApiConfig.log.Debug("WxPayApi", "MicroPay response : " + response);
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, int timeOut = 6)
        {
            ...
            WebApiConfig.log.Debug("WxPayApi", "Reverse request : " + xml);

            string response = HttpService.Post(xml, url, true, timeOut);

            WebApiConfig.log.Debug("WxPayApi", "Reverse response : " + response);
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, int timeOut = 6)
        {
            ...
            WebApiConfig.log.Debug("WxPayApi", "Refund request : " + xml);
            string response = HttpService.Post(xml, url, true, timeOut);//调用HTTP通信接口提交数据到API
            WebApiConfig.log.Debug("WxPayApi", "Refund response : " + response);
	    ...
	    */
        public static WxPayData RefundQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            WebApiConfig.log.Debug("WxPayApi", "RefundQuery request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            WebApiConfig.log.Debug("WxPayApi", "RefundQuery response : " + response);
        ...
        */
        public static WxPayData DownloadBill(WxPayData inputObj, int timeOut = 6)
        {
            ...
            WebApiConfig.log.Debug("WxPayApi", "DownloadBill request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            WebApiConfig.log.Debug("WxPayApi", "DownloadBill result : " + response);
	    ...
	    */
        public static WxPayData ShortUrl(WxPayData inputObj, int timeOut = 6)
        {
            ...
            WebApiConfig.log.Debug("WxPayApi", "ShortUrl request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);
            WebApiConfig.log.Debug("WxPayApi", "ShortUrl response : " + response);
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            inputObj.SetValue("mch_id", WxPayConfig.MCHID);//商户号
            // bug?
            //inputObj.SetValue("sub_mch_id", "1224294301");//商户号
            ...
            WebApiConfig.log.Debug("WxPayApi", "UnfiedOrder request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);
            WebApiConfig.log.Debug("WxPayApi", "UnfiedOrder response : " + response);
	    ...
	    */
        public static WxPayData Report(WxPayData inputObj, int timeOut = 1)
        {
            ...
            WebApiConfig.log.Info("WxPayApi", "Report request : " + xml);

            string response = HttpService.Post(xml, url, false, timeOut);

            WebApiConfig.log.Info("WxPayApi", "Report response : " + response);
