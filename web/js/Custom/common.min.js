...
var CommonFun = {
    checkFormat: function (d, c, a) {
        ...
        $("#" + a).table2excel({exclude: ".noExl", name: "Document", filename: "PatientList"})
...
httpModule.factory("ResourceFactory", [function () {
    var a = {};
    a.operateCode = {nothing: 0, get: 1, update: 2, insert: 3, remove: 4};
    a.statusCode = {
        Success: 0,
        NoLogin: 1,
        NoPermit: 2,
    ...
    a.module = 0;
    a.Auths = {
        OperateAuth_addPatient: {ModuleID: "M008", AuthID: "AU001", AuthValue: 4},
        OperateAuth_deletePatient: {ModuleID: "M008", AuthID: "AU002", AuthValue: 8},
        OperateAuth_lookPatientPhone: {ModuleID: "M008", AuthID: "AU003", AuthValue: 16},
        OperateAuth_exportPatient: {ModuleID: "M008", AuthID: "AU004", AuthValue: 32},
        OperateAuth_exportDataStatic: {ModuleID: "M008", AuthID: "AU005", AuthValue: 64},
        OperateAuth_exportMedical: {ModuleID: "M008", AuthID: "AU006", AuthValue: 128},
        OperateAuth_manageBookItem: {ModuleID: "M008", AuthID: "AU007", AuthValue: 256},
        OperateAuth_manageVisitItem: {ModuleID: "M008", AuthID: "AU008", AuthValue: 512},
        PatientCategory_self: {ModuleID: "M009", AuthID: "AU009", AuthValue: 2},
        PatientCategory_all: {ModuleID: "M009", AuthID: "AU010", AuthValue: 4},
        Supply_visit: {ModuleID: "M007", AuthID: "AU011", AuthValue: 2},
        SystemSet_visit: {ModuleID: "M006", AuthID: "AU012", AuthValue: 2},
        SystemSet_editMedical: {ModuleID: "M006", AuthID: "AU013", AuthValue: 4},
        SystemSet_setCostItem: {ModuleID: "M006", AuthID: "AU014", AuthValue: 8},
        SystemSet_setVisitItem: {ModuleID: "M006", AuthID: "AU015", AuthValue: 16},
        SystemSet_setAdvice: {ModuleID: "M006", AuthID: "AU016", AuthValue: 32},
        SystemSet_setBookItem: {ModuleID: "M006", AuthID: "AU017", AuthValue: 64},
        DataStatic_visit: {ModuleID: "M005", AuthID: "AU018", AuthValue: 2},
        DataStatic_daily: {ModuleID: "M005", AuthID: "AU019", AuthValue: 4},
        ClinicMG_visit: {ModuleID: "M004", AuthID: "AU020", AuthValue: 2},
        ClinicMG_editEmployee: {ModuleID: "M004", AuthID: "AU021", AuthValue: 4},
        ClinicMG_addEmployee: {ModuleID: "M004", AuthID: "AU022", AuthValue: 8},
        ClinicMG_deleteEmployee: {ModuleID: "M004", AuthID: "AU023", AuthValue: 16},
        ClinicMG_editPosition: {ModuleID: "M004", AuthID: "AU024", AuthValue: 32},
        BookMG_visit: {ModuleID: "M003", AuthID: "AU025", AuthValue: 2},
        BookMG_scheduling: {ModuleID: "M003", AuthID: "AU026", AuthValue: 4},
        PatientMG_visit: {ModuleID: "M002", AuthID: "AU027", AuthValue: 2},
        PatientMG_editPatient: {ModuleID: "M002", AuthID: "AU028", AuthValue: 4},
        PatientMG_addBill: {ModuleID: "M002", AuthID: "AU029", AuthValue: 8},
        PatientMG_accountRecharge: {ModuleID: "M002", AuthID: "AU030", AuthValue: 16},
        PatientMG_accountTransfer: {ModuleID: "M002", AuthID: "AU031", AuthValue: 32},
        PatientMG_accountRefund: {ModuleID: "M002", AuthID: "AU032", AuthValue: 64},
        PatientMG_editMedical: {ModuleID: "M002", AuthID: "AU045", AuthValue: 128},
        WorkPlatform_visit: {ModuleID: "M001", AuthID: "AU033", AuthValue: 2},
        WorkPlatform_editPatient: {ModuleID: "M001", AuthID: "AU034", AuthValue: 4},
        WorkPlatform_sign: {ModuleID: "M001", AuthID: "AU035", AuthValue: 8},
        WorkPlatform_treat: {ModuleID: "M001", AuthID: "AU036", AuthValue: 16},
        WorkPlatform_addBill: {ModuleID: "M001", AuthID: "AU037", AuthValue: 32},
        WorkPlatform_editMedical: {ModuleID: "M001", AuthID: "AU038", AuthValue: 128},
        WorkPlatform_accountRecharge: {ModuleID: "M001", AuthID: "AU046", AuthValue: 256},
        WorkPlatform_accountTransfer: {ModuleID: "M001", AuthID: "AU047", AuthValue: 512},
        WorkPlatform_accountRefund: {ModuleID: "M001", AuthID: "AU048", AuthValue: 1024},
        Bill_visit: {ModuleID: "M010", AuthID: "AU039", AuthValue: 2},
        Bill_pay: {ModuleID: "M010", AuthID: "AU040", AuthValue: 4},
        Bill_refund: {ModuleID: "M010", AuthID: "AU041", AuthValue: 8},
        Bill_editBill: {ModuleID: "M010", AuthID: "AU042", AuthValue: 16},
        Bill_cancelBill: {ModuleID: "M010", AuthID: "AU043", AuthValue: 32},
        Bill_editPayee: {ModuleID: "M010", AuthID: "AU044", AuthValue: 64},
        Equip_visit: {ModuleID: "M011", AuthID: "AU049", AuthValue: 2},
        Equip_editEquipment: {ModuleID: "M011", AuthID: "AU050", AuthValue: 4},
        Equip_exportEquipment: {ModuleID: "M011", AuthID: "AU051", AuthValue: 8},
        Account_visit: {ModuleID: "M012", AuthID: "AU052", AuthValue: 2},
        Account_refund: {ModuleID: "M012", AuthID: "AU053", AuthValue: 4}
    };
    ...
    a.GenerateCss = function () {
        ...
        var c = $("#mb_con").width();
        var e = $("#mb_con").height();
        $("#mb_con").css({top: (b - e * 2) / 2 + "px", left: (d - c) / 2 + "px"})
    };
    a.btnOk = function (b) {
    ...
    a.requestBody = function (b, e, d, c) {
        return {Header: {Token: b, StatusCode: 0, Module: a.module, Message: "", OperateCode: e, TimeStamp: c}, Body: d}
    };
    return a
}]);
...
httpModule.factory("HttpRequestFactory", ["HttpBaseFactory", "ResourceFactory", function (c, a) {
    ...
    b.GetStatementRequest = function (f, g, d, e) {
        c.baseRequest("https://ehospital.gy3y.com:8084/api/Pay/GetStatement", g, f, d, e)
    };
    b.CashierBillRequest = function (f, g, d, e) {
        c.baseRequest(WebServer.getUrl("CashierBill"), g, f, d, e)
    };
    b.IssueBillRequest = function (f, g, d, e) {
        c.baseRequest(WebServer.getUrl("IssueBill"), g, f, d, e)
    };
    b.RefundAmountRequest = function (f, g, d, e) {
        c.baseRequest(WebServer.getUrl("RefundAmount"), g, f, d, e)
    };
    b.GetStatementGroupRequest = function (f, g, d, e) {
        c.baseRequest(WebServer.getUrl("GetStatementGroup"), g, f, d, e)
    };
    return b
}]);
httpModule.service("HttpService", ["HttpRequestFactory", function (a) {
    ...
    b.CashierBillRequest = function (e, f, c, d) {
        a.CashierBillRequest(e, f, c, d)
    };
    b.IssueBillRequest = function (e, f, c, d) {
        a.IssueBillRequest(e, f, c, d)
    };
    b.RefundAmountRequest = function (e, f, c, d) {
        a.RefundAmountRequest(e, f, c, d)
    };
...
//var BaseURL = "http://www.niuluo-tech.cn:85/api/";
var WeChatURL = "http://www.niuluo-tech.cn/WebPages/WeChart/";
var FileURL = "http://www.niuluo-tech.cn:84/";
var ServerList = [{ActionName: "Login", Url: "User/Login"}, {
    ActionName: "VerifyCode",
    Url: "Tenant/SendSMS"
}, {ActionName: "Tenant", Url: "Tenant/TenantDeal"}, {
    ActionName: "Province",
    Url: "City/GetProvinceList"
}, {ActionName: "City", Url: "City/GetCityList"}, {
    ActionName: "District",
    Url: "City/GetDistrictList"
}, {ActionName: "Employee", Url: "User/UserDeal"}, {ActionName: "Role", Url: "Role/RoleDeal"}, {
    ActionName: "Patient",
    Url: "Patient/PatientDeal"
}, {ActionName: "Appointment", Url: "Appoint/AppointDeal"}, {
    ActionName: "Visit",
    Url: "Visit/VisitDeal"
}, {ActionName: "PatientDetail", Url: "Patient/PatientDetail"}, {
    ActionName: "PatientExport",
    Url: "Patient/ExportExcel"
}, {ActionName: "GetListForVisit", Url: "Appoint/GetListForVisit"}, {
    ActionName: "Cost",
    Url: "Cost/CostDeal"
}, {ActionName: "Treat", Url: "Treat/TreatDeal"}, {
    ActionName: "PatientSourceReport",
    Url: "Report/PatientSourceReport"
}, {ActionName: "PatientAddQuantityReport", Url: "Report/PatientAddQuantityReport"}, {
    ActionName: "DoctorCostReport",
    Url: "Report/DoctorCostReport"
}, {ActionName: "UpLoadFile", Url: "TreatFile/UploadFile"}, {
    ActionName: "UpLoadImage",
    Url: "TreatFile/UploadImage"
}, {ActionName: "UpLoadLogo", Url: "Tenant/UploadLogo"}, {
    ActionName: "PatientSourceExport",
    Url: "Report/PatientSourceExport"
}, {ActionName: "PatientAddQuantityExport", Url: "Report/PatientAddQuantityExport"}, {
    ActionName: "MainCategory",
    Url: "Category/CategoryDeal"
}, {ActionName: "SubCategory", Url: "SubCategory/SubCategoryDeal"}, {
    ActionName: "AppointItems",
    Url: "AppointItem/AppointItemDeal"
}, {ActionName: "RecordItems", Url: "RecordItem/RecordItemDeal"}, {
    ActionName: "VisitItems",
    Url: "VisitItem/VisitItemDeal"
}, {ActionName: "AdviceItems", Url: "AdviceItem/AdviceItemDeal"}, {
    ActionName: "AdviceContent",
    Url: "AdviceContent/AdviceContentDeal"
}, {ActionName: "CostItems", Url: "CostItem/CostItemDeal"}, {
    ActionName: "MedicalTemplate",
    Url: "Template/TemplateDeal"
}, {ActionName: "Permission", Url: "Module/ModuleDeal"}, {
    ActionName: "TemplateDeal",
    Url: "Template/AddOrUpdateTemplate"
}, {ActionName: "TemplateContent", Url: "TemplateContent/TemplateContentDeal"}, {
    ActionName: "ReportTreat",
    Url: "Report/TreatQuantityReport"
}, {ActionName: "ReportAppoint", Url: "Report/AppointItemQuantityReport"}, {
    ActionName: "TreatExport",
    Url: "Report/TreatQuantityExport"
}, {ActionName: "ReportCost", Url: "Report/CostReport"}, {
    ActionName: "CostExport",
    Url: "Report/CostExport"
}, {ActionName: "AppointExport", Url: "Report/AppointItemQuantityExport"}, {
    ActionName: "DentalClinicReport",
    Url: "Report/DentalClinicCostReport"
}, {ActionName: "DentalClinicExport", Url: "Report/DentalClinicCostExport"}, {
    ActionName: "EmployeeExport",
    Url: "Report/DoctorCostExport"
}, {ActionName: "TreatFileDelete", Url: "TreatFile/Delete"}, {
    ActionName: "TreatFile",
    Url: "TreatFile/TreatFileDeal"
}, {ActionName: "EncryptionData", Url: "User/GetUserInfo"}, {
    ActionName: "Logout",
    Url: "User/Logout"
}, {ActionName: "SendAdvice", Url: "WeChart/SendAdviceTemplateMessage"}, {
    ActionName: "AccountRecharge",
    Url: "Account/ReCharge"
}, {ActionName: "AccountTransfer", Url: "Account/Transferred"}, {
    ActionName: "AccountRefund",
    Url: "Account/Refund"
}, {ActionName: "CreateBill", Url: "Bill/CreateBill"}, {
    ActionName: "GetBillsByNo",
    Url: "Bill/GetBillByBillNo"
}, {ActionName: "GetBillsByAppoint", Url: "Bill/GetBillByAppoint"}, {
    ActionName: "GetBills",
    Url: "Bill/GetBills"
}, {ActionName: "CancelBill", Url: "Bill/CancelledBill"}, {
    ActionName: "PayBill",
    Url: "Bill/Pay"
}, {ActionName: "AppointTreat", Url: "Appoint/Treat"}, {
    ActionName: "AppointSign",
    Url: "Appoint/Sign"
}, {ActionName: "BillRefund", Url: "Bill/Refund"}, {
    ActionName: "FinishedBill",
    Url: "Bill/FinishedBill"
}, {ActionName: "AccountInfo", Url: "Account/AccountDeal"}, {
    ActionName: "ModifyPassword",
    Url: "Tenant/ModifyPassword"
}, {ActionName: "SendSMSForPassword", Url: "Tenant/SendSMSForPassword"}, {
    ActionName: "CreateSceneQRCode",
    Url: "WeChart/CreateSceneQRCode"
}, {ActionName: "EquipmentCategoryDeal", Url: "EquipmentCategory/EquipmentCategoryDeal"}, {
    ActionName: "EquipmentDeal",
    Url: "Equipment/EquipmentDeal"
}, {ActionName: "EquipmentExport", Url: "Equipment/EquipmentExport"},
    {ActionName: "CashierBill", Url: "Bill/CashierBill"},
    {ActionName: "IssueBill", Url: "Bill/IssueBill"},
    {ActionName: "RefundAmount", Url: "Bill/RefundAmount"},
    ...
    c.isWithModulePermission = function (e) {
        ...
        switch (e) {
            ...
            case MenuEnum.SupplyPlatform:
                f = d("产品目录");
                break;
            case MenuEnum.Endoscope:
                f = true;
                break;
            case MenuEnum.QuestionOrders:
                f = d("收银账单");
                ;
                break;
            default:
...
pushModule.service("PushMessageService", [function () {
    var d = new GoEasy({appkey: "bc7a9892-7813-437b-9ba9-688e9d37334e"});
    ...
    a.subChannel = function (f, g) {
        d.subscribe({
            channel: f, onMessage: function (h) {
                ...
                for (var j = 0; j < h.deliverMessages.length; j++) {
                    ...
                    if (k.Appoint.TenantID == e.TenantID) {
                        if (c.UserType == 1) {
                            ...
                            g.push({ID: k.Appoint.AppointID, Type: 1, Content: k})
                        } else {
            ...
            if (h.deliverMessages && h.deliverMessages.length > 0) {
                for (var j = 0; j < h.deliverMessages.length; j++) {
                    ...
                    if (k.TenantID == e.TenantID) {
                        f.msgCount++;
                        CommonFun.saveDataToSession("MsgCount", f.msgCount);
                        g.push({ID: k.PatientID, Type: 2, Content: k})
                    }
                }
                CommonFun.saveDataToSession("PushList", g);
                f.$apply()
...
menuModule.factory("menuFactory", ["$location", function (c) {
    ...
    return {
        menuList: [{
            ...
            ID: MenuEnum.Endoscope,
            title: "内窥镜管理",
            pageUrl: "http://www.ddoic.com/f/tooth/interface/getTokenCode?token=" + a.ThirdToken,
            icon: "icon-zoom-in",
            target: "_blank"
        }, {
            ID: MenuEnum.QuestionOrders,
            title: "分期账单",
            pageUrl: "../WebPages/QuestionOrders.html",
            icon: "icon-jpy",
            target: "_self"
...
menuModule.service("MenuService", ["ResourceFactory", "HttpService", "menuFactory", "PermissionFactory", "$upload", "$window", function (b, c, f, a, e, g) {
    ...
    d.logout = function () {
        try {
            c.logoutRequest("", b.operateCode.update, function (i) {
            }, function (i) {
            })
        } catch (h) {
            console.log(h)
    ...
    d.uploadFiles = function (i, h) {
        try {
            e.upload({url: WebServer.getUrl("UpLoadLogo"), file: i}).success(function (k) {
...
menuModule.controller("MenuController", ["$scope", "MenuService", "PushMessageService", function (a, c, b) {
    ...
    a.initialize = function () {
        ...
        window.onresize = function () {
            if (window.innerHeight >= 660) {
                ...
                if ((a.menuList.length * 60 + 10) > (window.innerHeight - 150)) {
                    a.maxNum = parseInt((window.innerHeight - 210) / 60);
                    $("#out_sidebar").css("height", a.maxNum * 60);
                    a.isShowScroll = true;
                }
                else {
                    a.maxNum = 0;
        ...
        a.tenantLogo = null;
        a.loginRequest = {UserName: "", Password: "", AccountType: 2, UserType: 1};
        a.accountTypeList = [{Type: 1, Name: "诊所主账户"}, {Type: 2, Name: "普通账户"}];
        if (h != null) {
        ...
        if ((a.menuList.length * 60 + 10) > (window.innerHeight - 150)) {
            ...
            $("#out_sidebar").css("height", a.maxNum * 60);
            a.isShowScroll = true;
            var menuSource = CommonFun.getDataFromSession("MenuSource");
            if (menuSource) {
                a.currentNav = parseInt(menuSource.currentNav);
                $(".sidebar-menu").css({"top": menuSource.topVal});
            }
        }
        else {
            $("#out_sidebar").css("height", (a.menuList.length * 60 + 10) + "px");
            a.maxNum = 0;
            a.isShowScroll = false;
        }
    };
    ...
    a.showPrevious = function () {
        if ((a.maxNum + a.currentNav) <= a.menuList.length && a.isCompleted) {
            a.isCompleted = false;
            a.currentNav = a.currentNav + 1;
            var topVal = $(".sidebar-menu").position().top;
            $(".sidebar-menu").animate({top: topVal - 60 + "px"}, "normal", "linear", function () {
                a.isCompleted = true;
            });
            CommonFun.saveDataToSession("MenuSource", {
    ...
    a.showNext = function () {
        if (a.currentNav > 1 && a.isCompleted) {
            a.isCompleted = false;
            a.currentNav = a.currentNav - 1;
            var topVal = $(".sidebar-menu").position().top;
            $(".sidebar-menu").animate({top: topVal + 60 + "px"}, "normal", "linear", function () {
    ...
    a.genders = [{Type: 1, Name: "男"}, {Type: 2, Name: "女"}];
    ...
    a.logout = function () {
        c.confirm("确定要退出当前系统吗？", function () {
            c.logout();
            CommonFun.deleteDataFromSession("MenuSource");
            CommonFun.deleteDataFromSession("CurrentUser");
    ...
    setActive: function (a) {
        switch (a) {
            ...
            case MenuEnum.SystemSet:
                ...
                break;
            case MenuEnum.QuestionOrders:
                $("#menu_" + MenuEnum.QuestionOrders).addClass("active");
                break;
            case MenuEnum.SupplyPlatform:
                break;
            default:
...
calendarModule.service("CalendarService", ["uiCalendarConfig", "$compile", function (b, d) {
    ...
    var h = function () {
        ...
        return {startTime: new Date(t, l, s, j, p), endTime: new Date(t, l, s, q, r)}
    };
    var e = function (k) {
        var j = new Date();
    ...
    g.events = [{id: 10000, title: "预约", start: c, end: f}];
    ...
    g.renewEvents = function () {
        var j = h();
        g.events.splice(0, 1);
        var k = {id: 10000, title: "预约", start: j.startTime, end: j.endTime};
        g.events.push(k)
    };
    g.select = function (n, j) {
        ...
        g.events.splice(0, 1);
        var m = {id: 10000, title: "预约", start: n, end: j};
        g.events.push(m);
        i.startTime = e(n);
        i.endTime = e(j);
                    ...
                    for (var b = c + 1; b < d.length; b++) {
                        if (f) {
                            if (parseInt(d[c].value) < parseInt(d[b].value)) {
                                var e = {value: d[b].value, position: d[b].position, isSelected: true};
                                d[b].value = d[c].value;
...
patientCommonModule.service("PatientCommonService", ["$compile", "PatientCommonFactory", "$http", function (d, b, g) {
    ...
    var a = function (j, k, n, o) {
        ...
        if (j.length > 0) {
            for (var l = 0; l < j.length; l++) {
                var m = {value: $(j[l]).text(), position: 1, isSelected: true};
                h.push(m)
            }
        }
        if (k.length > 0) {
            for (var l = 0; l < k.length; l++) {
                var m = {value: $(k[l]).text(), position: 2, isSelected: true};
                h.push(m)
            }
        }
        if (n.length > 0) {
            for (var l = 0; l < n.length; l++) {
                var m = {value: $(n[l]).text(), position: 3, isSelected: true};
                h.push(m)
            }
        }
        if (o.length > 0) {
            for (var l = 0; l < o.length; l++) {
                var m = {value: $(o[l]).text(), position: 4, isSelected: true};
                h.push(m)
            }
        }
        return h
            ...
            for (var C = 0; C < B.length; C++) {
                switch (Number(B[C].position)) {
                    case 1:
                        ...
                        if (D != undefined) {
                            D.TeethList.TopLeft.push({value: B[C].value, position: 1, isSelected: true})
                        } else {
                            $(z).append(E)
                        }
                        break;
                    case 2:
                        ...
                        if (D != undefined) {
                            D.TeethList.TopRight.push({value: B[C].value, position: 2, isSelected: true})
                        }
                        break;
                    case 3:
                        var E = "<span class='selected_tooth selected_tooth_right'>" + B[C].value + "</span>";
                        if (D != undefined) {
                            D.TeethList.BottomLeft.push({value: B[C].value, position: 3, isSelected: true})
                        } else {
                            $(k).append(E)
                        }
                        break;
                    case 4:
                        ...
                        if (D != undefined) {
                            D.TeethList.BottomRight.push({value: B[C].value, position: 4, isSelected: true})
                        }
                        break;
                    default:
                        break
    ...
    c.clickTooth = function (o, h, k, n) {
        ...
        if (!n && l.indexOf("selected_unit") > -1) {
            ...
            m = {value: $(o).text(), position: h, isSelected: true};
                ...
                g.get(FileURL + "Agreement/" + h.selectedAgreement.FileName).success(function (l) {
                    ...
                    if (q && q.length > 0) {
                        for (var n = 0; n < q.length; n++) {
                            var o = {Title: q[n].children[0].innerText.trim(), Type: 0, Items: []};
...
pagination.directive('pagination', function () {
    return {
        restrict: 'EA',
        template: "<div class='page txt_cen'>" +
        "<span style='margin-right: 2px' class='cus_btn item_h cus_w_3' ng-class='{cus_btn_c_4: currentPageNum <= 1, cus_btn_c_1: currentPageNum > 1}' ng-click='prevPage();'>上一页</span>" +
        "<span class='cus_btn item_h cus_w_3' ng-class='{cus_btn_c_4: currentPageNum >= conf.numberOfPages, cus_btn_c_1: currentPageNum < conf.numberOfPages}' ng-click='nextPage();'>下一页</span>" +
        "<span class='cus_w_3'>第<span ng-bind='currentPageNum'></span>页</span>" +
...
pagination.service('paginationService', function () {
    var service = {};
    service.initialize = function ($scope, perPage) {
        $scope.conf = {};
        // 显示页数
        $scope.conf.pagesLength = 3;
        // 每页显示条数
        $scope.conf.itemsPerPage = 8;
        if (perPage) {
            $scope.conf.itemsPerPage = perPage;
        }

        $scope.conf.currentPage = 1;
        $scope.currentPageNum = 1;
        // 设置总件数
        $scope.setTotalItems = function (num) {
            $scope.conf.totalItems = num;
        };
        ...
        $scope.prevPage = function () {
            if ($scope.pageList.length == 0 || $scope.currentPageNum <= 1) {
                return;
            }

            $scope.currentPageNum = $scope.currentPageNum - 1;
            $scope.conf.currentPage = $scope.currentPageNum;
            $scope.conf.changePage = true;
        };

        // nextPage
        $scope.nextPage = function () {
            if ($scope.pageList.length == 0 || $scope.currentPageNum >= $scope.pageList.length) {
                return;
            }
        ...
        $scope.jumpToPage = function () {
            if ($scope.jumpPageNum > 0 && $scope.jumpPageNum <= $scope.conf.numberOfPages) {
                var min = $scope.jumpPageNum;
                var max = min + $scope.conf.pagesLength - 1;
                max = max >= $scope.conf.numberOfPages ? $scope.conf.numberOfPages : max;
                $scope.pageList = [];
                for (var i = min; i <= max; i++) {
                    $scope.pageList.push(i);
                }

                if (max < $scope.conf.numberOfPages) {
                    $scope.pageList.push("...");
                }

                $scope.conf.currentPage = min;
            }
        };

        // 显示页数所在内容
        $scope.changePaginationContent = function (totalList, showList) {
            if (!parseInt($scope.conf.currentPage)) {
                return;
            }
            var min = ($scope.conf.currentPage - 1) * $scope.conf.itemsPerPage + 1;
            var max = min + $scope.conf.itemsPerPage - 1;
            max = max > $scope.conf.totalItems ? $scope.conf.totalItems : max;
            for (var i = min - 1; i < max; i++) {
                if (totalList && totalList.length > 0) {
                    showList.push(totalList[i]);
                }
            }
        };
    };
