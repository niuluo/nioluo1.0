var PlatformMG = {
    Init: function () {
        ...
        $($("#new_appoint input[name='name']")[0]).formValidator({validatorGroup: "3"}).functionValidator({fun: PlatformMG.validateRequired});
        $($("#new_appoint input[name='mobile']")[0]).formValidator({validatorGroup: "3"}).functionValidator({fun: PlatformMG.validateMobile});
        $($("#new_appoint input[name='workTime']")[0]).formValidator({validatorGroup: "3"}).functionValidator({fun: PlatformMG.validateDate});
        $.formValidator.initConfig({validatorGroup: "4", mode: "AlertTip"});
        $("#visitTime").formValidator({validatorGroup: "4"}).functionValidator({fun: PlatformMG.validateRequired});
        $("#visitItemsList").formValidator({validatorGroup: "4"}).functionValidator({fun: PlatformMG.validateRequired});
        $.formValidator.initConfig({validatorGroup: "2", mode: "AlertTip"});
        $("#visitTime").formValidator({validatorGroup: "2"}).functionValidator({fun: PlatformMG.validateRequired});
        $("#visitItemsList").formValidator({validatorGroup: "2"}).functionValidator({fun: PlatformMG.validateRequired})
...
module.factory("PlatformFactory", ["PatientCommonFactory", function (a) {
    var c = function (h) {
        var g = {TopLeft: [], TopRight: [], BottomLeft: [], BottomRight: []};
        if (h != null && h != "" && h != undefined) {
            ...
            if (d != undefined && d != null && d.length > 0) {
                for (var f = 0; f < d.length; f++) {
                    ...
                    switch (e[0]) {
                        case"a":
                            g.TopLeft.push({value: e[1], position: 1, isSelected: true});
                            break;
                        case"b":
                            g.TopRight.push({value: e[1], position: 2, isSelected: true});
                            break;
                        case"c":
                            g.BottomLeft.push({value: e[1], position: 3, isSelected: true});
                            break;
                        case"d":
                            g.BottomRight.push({value: e[1], position: 4, isSelected: true});
                            break;
                        default:
                            break
                    }
        ...
        DealMedicalRecord: function (n, m) {
            ...
            if (d != undefined && d != null && d.length > 0) {
                for (var e = 0; e < d.length; e++) {
                    ...
                    d[e].Category = {CategoryID: f.CategoryID, CategoryName: f.CategoryName};
                    d[e].SubCategory = {SubCategoryID: f.SubCategoryID, SubCategoryName: f.SubCategoryName}
                }
            }
            return d
            ...
            if (d != undefined && d != null) {
                ...
                d.Category = {CategoryID: e.categoryInfo.CategoryID, CategoryName: e.categoryInfo.CategoryName};
                d.SubCategory = {
...
module.service("PlatformService", ["HttpService", "ResourceFactory", "PlatformFactory", "PatientCommonService", "$upload", "PermissionFactory", function (b, c, j, m, h, f) {
        ...
        b.appointmentRequest(o, c.operateCode.get, function (p) {
            ...
            if (p.Header.StatusCode == 0) {
                if (p.Body == null || p.Body.AppointList == null || p.Body.AppointList.length <= 0) {
                    ...
                    if (o.Status == 0 && (o.Condition == "" || o.Condition == undefined)) {
                    } else {
                ...
                if (n.PatientList) {
                    angular.forEach(n.PatientList, function (u, t) {
                        s.push({label: u.Name + "--" + u.Mobile, value: JSON.stringify(u)});
                        r.push({label: u.Name, value: JSON.stringify(u)})
                    });
                    $("#language").autocomplete({
                        delay: 0, source: s, focus: function (t, u) {
                    ...
                    $("#app_p_name").autocomplete({
                        minLength: 1, source: r, focus: function (t, u) {
                            return false
                        }, select: function (u, v) {
                            var t = JSON.parse(v.item.value);
                            l(t);
    ...
    i.getAppointmentItemsList = function (n) {
        var o = {TenantID: n.currentUser.Body.Tenant.TenantID};
                ...
                if (q == undefined) {
                    ...
                    if (s.Body != null && s.Body.length > 0) {
                        ...
                        for (var u = 0; u < s.Body.length; u++) {
                            var t = {item: s.Body[u], categoryInfo: r};
    ...
    i.getCatalogItems = function (n, o, q) {
        var p = {TenantID: CommonFun.getDataFromSession("CurrentUser").Body.Tenant.TenantID};
        if (q != undefined && q == "") {
            p.CategoryID = q
        }
        try {
    ...
    i.showSelectedPatientDetail = function (q, s, p) {
        ...
        $(".tempPatientDetail").offset({top: n, left: t})
    };
    ...
    i.getMedicalRecord = function (n) {
        if (n.currentPatient != null && n.currentPatient != undefined) {
            var o = {AppointID: n.currentPatient.Appoint.AppointID}
        } else {
            return
        }
        try {
            ...
            switch (q) {
                case 1:
                    for (var t = 0; t < n.length; t++) {
                        ...
                        h.upload({url: o, data: r, file: n[t].file}).progress(function (w) {
                ...
                case 2:
                    ...
                    h.upload({url: o, data: r, file: p.File}).progress(function (w) {
                        var x = parseInt(100 * w.loaded / w.total)
                    }).success(function (w) {
                        if (w.Header.StatusCode == 0) {
                        ...
                        if (!o.currentPatient.PatientInfo.OpenID) {
                            ...
                            var r = {
                                ...
                                data: {
                                    ...
                                    keyword1: {value: o.currentPatient.Appoint.AppointItemName, color: "#173177"},
                                    keyword2: {value: o.currentMedicalRecord.Advice, color: "#173177"},
                                    keyword3: {value: o.currentPatient.Appoint.BeginTime, color: "#173177"},
    ...
    i.getMedicalContent = function (p) {
        var n = {TenantID: p.TenantID, TemplateID: p.TemplateID};
        try {
            ...
            b.getBillRequest(o, c.operateCode.get, function (q) {
                ...
                if (q.Header.StatusCode == 0) {
                    ...
                    if (n.billList && n.billList.length > 0) {
                        var r = {BillNo: n.billList[0].BillNo};
        ...
        try {
            b.accountRechargeRequest(o, c.operateCode.insert, function (q) {
                ...
                if (q.Header.StatusCode == 0) {
                    ...
                    i.alert("充值成功！");
                    var r = {TenantID: o.TenantID, PatientID: o.PatientID};
...
module.controller("PlatformController", ["$scope", "PlatformService", "CalendarService", "$location", "PatientCommonService", "$compile", "$timeout", "PushMessageService", function (k, b, a, g, l, e, c, i) {
    k.showUrl = FileURL;
    k.visitStateList = [{Value: 0, Text: "全部"}, {Value: 1, Text: "待跟进"}, {Value: 2, Text: "已回访"}, {
        Value: 3,
        Text: "未访"
    }];
    k.genderList = [{Value: 1, Text: "男"}, {Value: 2, Text: "女"}];
    k.appointTypeList = [{Value: 1, Text: "初诊"}, {Value: 2, Text: "复诊"}];
    k.searchData = {
        patient: {},
        visit: {},
        bill: {
    ...
    k.initialize = function () {
        ...
        k.appointStatusList = [{Value: 1, Text: "已预约"}, {Value: 2, Text: "候诊中"}, {Value: 3, Text: "治疗中"}, {
            Value: 4,
            Text: "已完成"
        }, {Value: 5, Text: "预约未到"}];
        ...
        if (m) {
            switch (m.JobTitle) {
                case 2:
                case 3:
                    k.bookStateList = [{Value: 0, Text: "状态(全部)"}, {Value: 1, Text: "已预约"}, {
                        Value: 2,
                        Text: "候诊中"
                    }, {Value: 3, Text: "治疗中"}, {Value: 4, Text: "已完成"}, {Value: 5, Text: "预约未到"}];
                    break;
                case 1:
                    k.bookStateList = [{Value: 0, Text: "状态(全部)"}, {Value: 2, Text: "候诊中"}, {
                        Value: 3,
                        Text: "治疗中"
                    }, {Value: 4, Text: "已完成"}];
                    break;
        ...
        k.relationList = [{Type: 1, Name: "亲属"}, {Type: 2, Name: "朋友"}, {Type: 3, Name: "同事"}, {
            Type: 4,
            Name: "同学"
        }, {Type: 5, Name: "其他"}];
        k.billStateList = [{Type: 0, Name: "全部"}, {Type: 1, Name: "待收费"}, {Type: 2, Name: "欠费"}, {
            Type: 3,
            Name: "已作废"
        }, {Type: 4, Name: "已完成"}];
        b.initialize(k);
        ...
        $($("#medical_record input[name='ChiefComplaints']")[0]).formValidator({validatorGroup: "6"}).functionValidator({fun: PlatformMG.validateLength});
        $($("#medical_record input[name='PresentIllness']")[0]).formValidator({validatorGroup: "6"}).functionValidator({fun: PlatformMG.validateLength});
        $($("#medical_record input[name='PastHistory']")[0]).formValidator({validatorGroup: "6"}).functionValidator({fun: PlatformMG.validateLength});
        $($("#medical_record input[name='AllergyHistory']")[0]).formValidator({validatorGroup: "6"}).functionValidator({fun: PlatformMG.validateLength});
        $($("#medical_record textarea[name='jianchaContent']")[0]).formValidator({validatorGroup: "6"}).functionValidator({fun: PlatformMG.validateLength});
        $($("#medical_record textarea[name='fuzhujiancha']")[0]).formValidator({validatorGroup: "6"}).functionValidator({fun: PlatformMG.validateLength});
        $($("#medical_record textarea[name='zhenduanContent']")[0]).formValidator({validatorGroup: "6"}).functionValidator({fun: PlatformMG.validateLength});
        $($("#medical_record textarea[name='zhiliaoContent']")[0]).formValidator({validatorGroup: "6"}).functionValidator({fun: PlatformMG.validateLength})
    };
    k.blurHide = function (m, n) {
        $(document).click(function (p) {
            var t = p, s = $(t.srcElement || t.target);
            if ($(s).is("#" + n + ",#" + n + " *")) {
                var r = $($(s)[0]).parent()[0];
    ...
    k.$watch("selectedPatient", function () {
        ...
        k.addVisit.Gender = n.Gender;
        k.addVisit.Mobile = n.Mobile;
        var m = {PatientID: n.PatientID, TenantID: k.currentUser.Body.Tenant.TenantID};
    ...
    k.showBaseDetail = function (p, o, r, n, s) {
        ...
        if (n && (n.button == 0 || n.button == 2)) {
            if (n.button == 2) {
                var q = "";
                var m = {name: "", textLimit: 10, offsetX: 3, offsetYs: 3, beforeShow: $.noop, afterShow: $.noop};
                if (r) {
                    switch (p.Visit.Status) {
                        case 1:
                        case 3:
                            m.name = "menu_5";
                            q = [[{text: "取消回访", func: k.deleteVisit}], [{
                                text: "复诊预约",
                                func: k.otherAppointForVisit
                            }], [{text: "查看详情", func: k.gotoDetailPageForVisit}]];
                            break;
                        case 2:
                            m.name = "menu_6";
                            q = [[{text: "复诊预约", func: k.otherAppointForVisit}], [{
                                text: "查看详情",
                    ...
                    switch (p.Appoint.Status) {
                        ...
                        case 5:
                            m.name = "menu_1";
                            q = [[{text: "取消预约", func: k.deleteAppoint}], [{
                                text: "预约改期",
                                func: k.goToAppointManagement
                            }], [{text: "查看详情", func: k.gotoDetailPageForAppoint}]];
                            break;
                        case 2:
                            m.name = "menu_2";
                            q = [[{text: "查看详情", func: k.gotoDetailPageForAppoint}]];
                            break;
                        case 3:
                            m.name = "menu_3";
                            q = [[{text: "复诊预约", func: k.otherAppointForAppoint}], [{
                                text: "查看详情",
                                func: k.gotoDetailPageForAppoint
                            }], [{text: "编辑病案", func: k.editMedicalRecord}]];
                            break;
                        case 4:
                            m.name = "menu_4";
                            q = [[{text: "复诊预约", func: k.otherAppointForAppoint}], [{
    ...
    k.addAppointToDB = function () {
        ...
        var n = {Appoint: k.addAppoint, Source: p, Level: o};
    ...
    k.checkAppoint = function (o, m, p) {
        ...
        if (p == 2) {
            var n = {AppointID: k.currentPatient.Appoint.AppointID, TenantID: k.currentPatient.PatientInfo.TenantID};
            b.signAppoint(n, k)
        } else {
            var n = {
                Status: p,
    ...
    k.createTree = function (r, t) {
        ...
        var u = {
            context1: {
                elements: [{
                    text: "展开", icon: "icon-star-empty", action: function (x) {
                        x.expandNode()
                    }
                }, {
                    text: "收缩", icon: "icon-star-empty", action: function (x) {
                        x.collapseNode()
                    }
                }]
            }
    ...
    k.resetCharge = function (m) {
        ...
        k.Description = "";
        if (m == 0) {
            b.getFee({AppointID: k.currentPatient.Appoint.AppointID}, k)
        } else {
            k.setCharge()
        }
    };
    ...
    k.showFileDetail2 = function (p, s, m) {
        if ($(s.target).prop("tagName") == "IMG") {
            k.showFileDetail(p, {target: $(s.target).parent().prev()}, m);
        } else {
            k.showFileDetail(p, {target: $(s.target).prev()}, m);
        }
    };
    k.showFileDetail = function (p, s, m) {
        ...
        $(n).css({left: r, top: -20, height: 100, width: 200, position: "absolute"});
        switch (p.FileType) {
            case 1:
        ...
        if (p != undefined && p != "" && p.length > 0) {
            for (var m = 0; m < p.length; m++) {
                ...
                if (p[m].name.indexOf(".jpg") > -1 || p[m].name.indexOf(".png") > -1 || p[m].name.indexOf(".gif") > -1 || p[m].name.indexOf(".jpeg") > -1 || p[m].name.indexOf(".svg") > -1) {
                    o = 1;
                    n = "icon-picture";
                    k.newFiles.push({type: 1, file: p[m]})
                } else {
    ...
    k.getAdviceContent = function () {
        if (k.currentPatient && k.selectedAdviceTemplate && k.selectedAdviceTemplate.Name) {
            var m = {TenantID: k.currentPatient.Appoint.TenantID, AdviceItemID: k.selectedAdviceTemplate.AdviceItemID};
    ...
    k.billPay = function () {
        ...
        k.ChargeTypeList = [{Type: "1", Name: "现金"}, {Type: "2", Name: "银行卡"}, {Type: "3", Name: "微信"}, {
            Type: "4",
            Name: "支付宝"
        }, {Type: "5", Name: "社保卡"}, {Type: "6", Name: "会员卡"}, {Type: "8", Name: "其他"}]
    };
    ...
    k.billRefund = function () {
        ...
        k.RefundTypeList = [{Type: "1", Name: "现金"}, {Type: "3", Name: "微信"}, {Type: "4", Name: "支付宝"}, {
            Type: "8",
            Name: "其他"
        }];
    ...
    k.finishBill = function () {
        ...
        b.confirm("您正在结束账单，患者姓名：【" + k.currentBillDetail.Patient.Name + "】,账单号：【" + k.currentBillDetail.Bill.BillNoStr + "】，账单金额：【" + k.currentBillDetail.Bill.DueCharge + "】元；是否继续？", function () {
            var m = {BillNo: k.currentBillDetail.Bill.BillNo};
            b.finishedBill(m, k)
        })
    };
    ...
    k.amountRecharge = function () {
        if (k.currentPatient) {
            ...
            k.recharge = {RechargeAmount: 0, RechargeType: "8", Remark: ""};
            k.transfer = {TransferAmount: 0, Remark: "", SelectedPatientID: ""};
            k.refund = {RefundAmount: 0, Remark: ""};
            var m = {
                TenantID: k.currentPatient.PatientInfo.TenantID,
                PatientID: k.currentPatient.PatientInfo.PatientID
            };
    ...
    k.getQRCode = function () {
        ...
        var m = {PatientID: k.currentPatient.PatientInfo.PatientID};
        k.operateType = 0;
        b.getQRCodeInfo(m, k)
    };
    k.getBillQRCode = function () {
        ...
        var m = {PatientID: k.currentBillDetail.Bill.PatientID};
        k.operateType = 1;
        b.getQRCodeInfo(m, k)
    };
    ...
    k.recordCurrentItem = function (m, n, o) {
        k.currentDom = {DomObj: angular.element(m.target), ContentType: n, IsOld: o}
    };
    k.initialize()
}]);
