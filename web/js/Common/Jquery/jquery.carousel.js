(function(jq){
    ...
    posterTvGrid.prototype = {
        reset: function(options){
            ...
            this.preLeft = 0;
            this.nextLeft = this.options.width - (this.options.width/3);
            this.preNLeft = -(this.options.width/3);
            this.nextNLeft = this.options.width;
            this.pageNowLeft = (this.options.width)/4;
            this.drawContent();
        },
        drawContent: function(){
            ...
            this.bottomNav.style.marginTop = parseInt(this.options.height) - 250 + "px";
            for(var i=1; i<= this.total; i++){
                ...
                leftCon.className = "leftNav";
                rightCon.className = "rightNav";
                leftCon.style.width = "50px";
                leftCon.style.borderRadius = "8px";
                leftCon.style.backgroundPositionY = "50%";
                leftCon.style.backgroundColor = "darkgray";
                leftCon.style.marginTop = "0";
                leftCon.style.height = "60px";
                rightCon.style.width = "50px";
                rightCon.style.height = "60px";
                rightCon.style.borderRadius = "8px";
                rightCon.style.backgroundPositionY = "50%";
                rightCon.style.backgroundColor = "darkgray";
                rightCon.style.marginTop = "0";

                if(this.total * 100 >= this.options.width)
                {
                    leftCon.style.left = "7px";
                    rightCon.style.right = "7px";
                }
                else
                {
                    leftCon.style.left = (this.options.width - this.total * 100) / 2 - 70+ "px";
                    rightCon.style.right = (this.options.width - this.total * 100) / 2  - 70 + "px";
                }

                var bottomImg = document.createElement("IMG");
                bottomImg.src = this.data[i-1].img;
                if(i == 1)
                {
                    this.bottomNav.appendChild(leftCon);
                }
                ...
                if(i == this.total)
                {
                    this.bottomNav.appendChild(rightCon);
                }
            }
        ...
        initContent: function(){
            ...
            this.parent.find(".contentHolderUnit:nth-child("+this.pageNow+")").css({width:this.options.width/2+'px',height:(this.options.width/3 - 100)+'px', opacity: 1, left: this.pageNowLeft+'px', zIndex: 3, marginTop: 0});
            ...
            this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 1, left: this.preLeft+'px',height: (this.options.width/3 - 150)+'px', width: this.options.width/3+"px", zIndex: 0, marginTop: '23px'});
            ...
            this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 1, left: this.nextLeft+'px',height: (this.options.width/3 - 150)+'px', width: this.options.width/3+"px", zIndex: 0, marginTop: '23px'});
        ...
        initBottomNav: function(){
            ...
            this.parent.find(".bottomNavButtonOFF[ref="+this.pageNow+"]").addClass("bottomNavButtonON");
        },
        start: function(){
            var _this = this;
        ...
        turnpage: function(page, dir){
            ...
            var run = function(page, dir, t){
                ...
                if(dir == 'left'){
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height: (_this.options.width/3 - 150)+'px', width: _this.options.width/3+"px", zIndex: 2, marginTop: '23px'}, t);
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+page+")").animate({opacity: 1, left: _this.pageNowLeft+'px', height: (_this.options.width/3 - 100)+"px", width: _this.options.width/2+'px', zIndex: 3, marginTop: '0'}, t);
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+next+")").css({opacity: 0, left: _this.nextNLeft+'px', height: '100px', width: _this.options.width/3+"px", zIndex: 2, marginTop: '85px'});
                    _this.parent.find(".contentHolderUnit:nth-child("+next+")").animate({opacity: 1, left: _this.nextLeft+'px', height: (_this.options.width/3 - 150)+'px', width:_this.options.width/3+"px", zIndex: 2, marginTop: '23px'}, t);
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+page+")").animate({opacity: 1, left: _this.pageNowLeft+'px', height: (_this.options.width/3 - 100)+"px", width: _this.options.width/2+'px', zIndex: 3, marginTop: '0px'}, t);
                    _this.parent.find(".contentHolderUnit:nth-child("+page+") .elementOverlay").css({opacity:0});
                    _this.parent.find(".contentHolderUnit:nth-child("+page+") .leftShadow").css({opacity:1});
                    _this.parent.find(".contentHolderUnit:nth-child("+page+") .rightShadow").css({opacity:1});

                    _this.parent.find(".contentHolderUnit:nth-child("+pre+")").css({opacity: 0, left: _this.preNLeft+'px', height: '100px', width: _this.options.width/3+"px", zIndex: 2, marginTop: '85px'});
                    _this.parent.find(".contentHolderUnit:nth-child("+pre+")").animate({opacity: 1, left: _this.preLeft+'px', height: (_this.options.width/3 - 150)+'px', width: _this.options.width/3+"px", zIndex: 2, marginTop: '23px'}, t);
                    _this.parent.find(".contentHolderUnit:nth-child("+pre+") .elementOverlay").css({opacity:0.4});
                    _this.parent.find(".contentHolderUnit:nth-child("+pre+") .leftShadow").css({opacity:0});
                    _this.parent.find(".contentHolderUnit:nth-child("+pre+") .rightShadow").css({opacity:0});
                    ...
                    _this.parent.find(".contentHolderUnit:nth-child("+nextN+")").animate({width:_this.options.width/3+"px",height:'100px', opacity: 0, left:_this.nextNLeft+'px', zIndex:0, marginTop: '85px'}, t, "",function(){_this.locked=false;});
                }
